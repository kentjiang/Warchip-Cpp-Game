...
bool to_game(){
    ...
    Bomb *bomb = new Bomb(0, 20, rect_bullet, warship, explosion, 10);
    Warship *mywarship = new Warship(13, 13, rect_ship, NULL, 5, 5, explosion, bullet, bomb);



    Boss *myboss = new Boss(0, 5, rect_boss, enemy1, 2, 2, explosion, bullet_e, 30);
    
    Enemy *myenemy = new Enemy(0, 5, rect_enemy, enemy, 1, 1, explosion, bullet_e, 30);
    Enemy *myenemy1 = new Enemy(0, 5, rect_enemy1, enemy1, 2, 2, explosion, bullet_e, 30);
...
//===========================================
    ...
    //     for(unordered_set<Bomb *>::iterator ite = friend_bombs.begin(); ite != friend_bombs.end(); ite++)
    //     {
